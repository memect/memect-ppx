"""Image loading and dimension inference for PPTX media."""
...
def _identify_image(data: bytes, *, suffix: str = "") -> tuple[str, str, tuple[int, int] | None]:
    ...
    if data.startswith(b"\xff\xd8"):
        return "jpg", "image/jpeg", _jpeg_size(data)
...
def _resolve_size(
    ...
    width_len = ensure_length(width, default_unit="pt")
    height_len = ensure_length(height, default_unit="pt")
